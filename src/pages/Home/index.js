      ...
      <div className="bg-main-gary-light-color">
        ...
        <Container className="">
          <div>
            ...
            <img src={BrandWord} alt="Logo" width="300" className="img" />
            <img src={Note} alt="Logo" width="40" className="note" />
            <img src={Note2} alt="Logo" width="25" className="note2" />
          ...
          <div className="d-flex justify-content-end ">
            ...
            <img src={Note4} alt="Logo" height="" width="" className="note4" />
            <img src={Note3} alt="Logo" height="" width="" className="note3" />
          </div>
          <div className="d-flex justify-content-end ">
            <img src={Img2} alt="Logo" height="175" width="285" className="" />
          </div>
        </Container>
      </div>
    </>
